<?php
include "../../../../modal/ecommerce/pedido/gerenciar_pedido.php";
?>
<?php
...
?>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <th><?= "Nº " . $pedido . "<br>" . $span_anuncio . "<hr class='mb-1'> Data: $data_pedido";  ?></th>
                    <th title='Número do documento fiscal (venda ou Nf-e)'><?php
                                                                            if ($pdf_nf != "") {
                                                                                echo $numero_nf .
                    ...
                    ?>
                        <td><button type="button" id="<?= $pedido_id; ?>" class="btn btn-sm btn-info editar">Detalhe</button></td>
                    <?php } else {
                        echo "<td></td>";
                    } ?>
                </tr>
...
?>
<script src="js/ecommerce/pedido/table/editar_pedido.js">