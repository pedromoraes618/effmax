                        ...
                        <div class="btn-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item dados_parceiro" style="cursor: pointer;" 
                                    codigo_nf='<?php echo $codigo_nf; ?>' parceiro_id ='<?php echo $parceiro_id; ?>' nf_saida_id="<?php echo $id_b; ?>">Cadastro do Fornecedor</a></li>
