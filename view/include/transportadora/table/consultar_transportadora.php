                ...
                <tr class="rounded">
                    ...
                    <td class="td-btn">
                        <?php if ($situacao_b == "SIM") { ?>
                            <button type="button" r_social=<?php echo $razao_social_b; ?> id_parceiro=<?php echo $cliente_id_b; ?> class="btn btn-info   btn-sm selecionar_transportadora ">Selecionar</button>
                        <?php } ?>
                    </td>
...
?>
<script src="js/include/transportadora/pesquisa_transportadora.js">