    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row g-3 align-items-center mb-2">
                    <div class="col-md mb-2">
                        <input type="text" class="form-control" id="informativo_carta_correcao_nf" placeholder="Informe a correção">
                    </div>
                    <div class="col-auto">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success btn-sm enviar_carta_correcao_nf">Enviar</button>
...
<script src="js/include/nf_fiscal/carta_correcao_nf.js"></script>
