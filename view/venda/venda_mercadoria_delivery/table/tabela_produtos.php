    ...
    <table class="table table-hover">
        ...
        <tbody id="tabela_produtos">
            ...
            while ($linha = mysqli_fetch_assoc($consultar_produtos)) {
                ...
                $tipo_item = $linha['cl_tipo_item_delivery'];
                    ...
                    <tr>
                        ...
                        <td class="td-btn">
                            <div class="btn-group">
                                ...
                                <button type="button" produto_id='<?php echo $id; ?>' id_item_nf='<?php echo $id; ?>' title='Editar item' class="btn btn-sm btn-info alterar_produto_vnd">Editar</button>
                                <button type="button" produto_id='<?php echo $id; ?>' id_item_nf='<?php echo $id; ?>' title='Observação' class="btn btn-sm btn-warning incluir_observacao_prod">Obs</button>
                            </div>
                        </td>
...
<script src="js/venda/venda_mercadoria_delivery/table/tabela_produtos.js">