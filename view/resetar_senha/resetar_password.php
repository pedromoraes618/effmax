            ...
            <div class="group-bloco">
                ...
                <form id="formulario_resetar_senha">
                    <div class="group-input">
                        ...
                        <div class="gp-input">
                            <input type="text" class="form-control" id="nova_senha" name="nova_senha" placeholder="Nova Senha">
                        </div>
                        <div class="gp-input">
                            <input type="text" class="form-control" id="confirmar_Senha" name="confirmar_senha" placeholder="Confirme sua nova senha">
                        </div>
                    </div>
                    ...
                    <p class="reservado">© [2023] Effmax. Todos os direitos reservados</p>
                </form>
            </div>
