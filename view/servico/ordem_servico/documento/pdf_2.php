    ...
    <div class="container">
        ...
        <div class="p-2 ">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><strong>Local: </strong> <?= $local_atividade; ?></td>
                    </tr>
        ...
        <div class="p-2">
            <table>
                <thead>
                    <tr>
                        <th colspan="6"><i class="bi bi-archive"></i> Material</th>
                    </tr>
                    <tr>
                        <th>Item</th>
                        <th>Descrição</th>
        ...
        <?php if ($qtd_despesa > 0) { ?>
            <div class="p-2">
                <table>
                    <thead>
                        <tr>
                            <th colspan="5"><i class="bi bi-wallet"></i> Despesa</th>
                        </tr>
                        <tr>
                            <th>Descrição</th>
                            <th>Classificação</th>
                    ...
                    <tbody>
                        <?php
                        $total = 0;
                        while ($linha = mysqli_fetch_assoc($consulta_despesa)) {
                            $item += 1;
