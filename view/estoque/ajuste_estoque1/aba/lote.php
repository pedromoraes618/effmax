        ...
        <div class="accordion-item mb-2 ">
            ...
            <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show ">
                <div class="accordion-body">
                    ...
                    <form id="ajuste_estoque_lote" style="max-height: 900px;">
                        <div class="row mb-2 d-flex align-items-end">
                            ...
                            <div class="col-md-auto">
                                <div class="input-group">
                                    <div class="col-md-auto">
                                        <select class="form-select chosen-select bg-body-secondary" name="tipo_ajuste">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" placeholder="0.00" step="any" class="form-control" name="qtd">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="js/estoque/ajuste_estoque1/aba/lote.js"></script>