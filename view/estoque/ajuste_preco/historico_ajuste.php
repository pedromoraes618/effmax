<?php include "../../../modal/estoque/ajuste_preco/gerenciar_ajuste_preco.php"; ?>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Ajuste de preço</h1>
                    ...
                    <div class="row">
                        <div class="card m-1 card-print card-dashboard position-relative shadow border-0 mb-2 ">
                            <div class="card-header header-card-dashboard ">
                                <h6><i class="bi bi-exclamation-octagon"></i> Ajuste de preço</h6>
                            </div>
                            <div class="card-body table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody id="produtos-tbody">
                                        ...
                                        while ($linha = mysqli_fetch_assoc($consultar)) {
                                            ...
                                            $usuario = utf8_decode($linha['cl_usuario']);
                                            $descricao =  utf8_decode($linha['cl_descricao']);
                                            $tipo = $linha['tipoajst'];
                                            $unidade = $linha['cl_unidade'];
                                            $valor_antigo = $linha['cl_valor_antigo'];
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $descricao; ?></td>
                                                <td><?= $tipo; ?></td>
                                                <td><?= real_format($valor_antigo); ?></td>
                                ...
                                <div class="adjustment-info">
                                    <div>
                                        <p class="mb-1">Ajuste: <span><?= $ajuste_codigo; ?></span></p>
                                    </div>
                                    <div>
