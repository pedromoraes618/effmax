...
<div class="container">
    <div class="mb-3">
        <h4 class="fw-semibold">Ajuste as promoções</h4>
        <span>Atualize as promoções</span>
    </div>
            ...
            <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show ">
                <div class="accordion-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-2 mb-2">
                            <select name="status_promocao" class="form-select chosen-select" id="status_promocao">
                    ...
                    <form id="ajuste_preco_promocao" style="max-height: 900px;">
                        <div class="row mb-2 d-flex align-items-end">
                            ...
                            <div class="col-md">
                                <div class="input-group">
                                    <span class="input-group-text">Duração da Promoção</span>
                                    <input type="date" class="form-control" id="duracao_promocao" name="duracao_promocao" title="Validade" value="">
                                </div>
                            </div>
                        </div>
...
<script src="js/estoque/ajuste_preco/aba/promocao.js"></script>