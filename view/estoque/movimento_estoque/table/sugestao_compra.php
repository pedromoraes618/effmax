...
<div class="card m-1 card-print card-dashboard position-relative shadow border-0 mb-2 ">
    <div class="card-header header-card-dashboard ">
        <h6><i class="bi bi-exclamation-octagon"></i> Sujestão de Compra</h6>
    </div>
            ...
            <table class="table  table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="table-active">Repor</th>
                        <th scope="col" title='Última Compra'>Custo</th>
                        <th scope="col" title='Última Compra'>Venda</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="table-active"><?php echo formatarNumero($repor); ?></th>

                            <td><?php echo real_format($preco_custo); ?></th>
                            <td><?php echo real_format($preco_venda); ?></th>
