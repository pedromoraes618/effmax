...
<div class="card m-1 card-print card-dashboard position-relative shadow border-0 mb-2 ">
    <div class="card-header header-card-dashboard ">
        <h6><i class="bi bi-exclamation-octagon"></i> Produto Sem Estoque</h6>
    </div>
            ...
            <table class="table  table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="table-active" scope="col">Estoque</th>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <td><?php echo "Cód: $codigo <br>" . ($produto) . "<br>" . $referencia; ?></th>
                            ...
                            <td> <?php echo  real_format($preco_custo_unit); ?></td>
                            <td> <?php echo  real_format($valor_vendido); ?></td>
