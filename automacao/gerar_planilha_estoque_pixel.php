...
// Escrevendo as colunas no arquivo CSV
foreach ($colunas as $coluna) {
    fwrite($arquivo, $coluna . ";");
}
fwrite($arquivo, "\n");
...
if ($resultados) {
    foreach ($resultados as $linha) {
        ...
        // Montando os dados do produto para o CSV
        $dados_produto = [
            $productID,
            $descricao,
            $produto_descricao,
        ...
        // Escrevendo os dados do produto no arquivo CSV
