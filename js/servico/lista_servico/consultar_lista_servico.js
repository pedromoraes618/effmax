...
var status_servico = document.getElementById("status_servico");
...
$.ajax({
    type: 'GET',
    data: "consultar_lista_servico=inicial&conteudo_pesquisa=" + conteudo_pesquisa.value,
    url: "view/servico/lista_servico/table/consultar_lista_servico.php",
    success: function (result) {
...
$("#pesquisar_filtro_pesquisa").click(function () {//realizar a pesquisa
    ...
    $.ajax({
        type: 'GET',
        data: "consultar_lista_servico=detalhado&conteudo_pesquisa=" + conteudo_pesquisa.value + "&status=" + status_servico.value,
        url: "view/servico/lista_servico/table/consultar_lista_servico.php",
        success: function (result) {
            return $(".bloco-pesquisa-menu .bloco-pesquisa-1 .tabela").html(result);
        },
