...
var id_formulario = document.getElementById("id")
var titulo = document.getElementById('title_modal')
var btn_form = document.getElementById('button_form')
...
$("#modal_produto").click(function () {
    ...
    $.ajax({
        type: 'GET',
        data: "adicionar_produto=true&item=" + descricao_produto,
        url: "view/include/produto/pesquisa_produto_delivery.php",
        success: function (result) {
            return $(".modal_externo").html(result) + $("#modal_pesquisa_produto_delivery").modal('show');
...
if (id_formulario.value == "") {
    ...
    $('#concluir_venda').click(function () {
        ...
        var valor_entrega = parseFloat($("#valor_entrega").val()) || 0;
        var sub_total = valor_total_produtos + valor_entrega
        ...
        if (codigo_nf.value == "") {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    vlr_total_venda: sub_total,
                },
                url: "view/include/finalizar_venda_delivery/finalizar_venda.php",
                success: function (result) {
...
function tabela_produtos(codigo_nf) {//tabela de produtos
    $.ajax({
        ...
        url: "view/venda/venda_mercadoria_delivery/table/tabela_produtos.php",
        success: function (result) {
        ...
        if ($dados.sucesso == true) {
            ...
            if ($dados.acao == "finalizar_venda") {
                ...
                if ($dados.recibo == "S") {//Recibo setado com S  para abrir o recibo ao finalizar a venda
                    var janela = "view/delivery/pedido/comanda/modelo_2.php?comanda2=true&pedido_id=" + $dados.pedido_id;
...
function show(id, codigo_nf) {
    ...
    function sucesso(data) {
        ...
        if ($dados.sucesso == true) {
            ...
            $("#endereco_delivery").val($dados.valores['endereco_delivery'])
            $("#opcao_delivery").val($dados.valores['opcao_delivery'])
