...
$(document).ready(function () {
    ...
    $.ajax({
        type: 'GET',
        data: "consultar_devolucao_venda=inicial&conteudo_pesquisa=" + conteudo_pesquisa.value + "&data_inicial=" + data_inicial.value + "&data_final=" + data_final.value,
        url: "view/venda/devolucao_venda/table/consultar_venda.php",
...
$("#pesquisar_filtro_pesquisa").click(function () {//realizar a pesquisa
    $.ajax({
        type: 'GET',
        data: "consultar_devolucao_venda=detalhado&conteudo_pesquisa=" + conteudo_pesquisa.value +
